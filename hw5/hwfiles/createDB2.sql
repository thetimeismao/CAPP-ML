...
CREATE INDEX activity_idx_client
ON activity (client_id);

CREATE INDEX activity_idx_lobby 
ON activity (lobbyist_id);

CREATE INDEX compensation_idx_lobby
ON compensations (lobbyist_id);

CREATE INDEX expenditure_idx_client
ON expenditures (client_id);